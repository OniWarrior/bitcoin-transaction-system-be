exports.up = function (knex) {
    return knex.schema
        ...
        .createTable('Client', Client => {
            ...
            Client.decimal('USD_balance', 10, 2).notNullable().default(0.00)
            Client.decimal('Bitcoin_balance', 10, 2).notNullable().default(0.00)
        ...
        .createTable('Trader', Trader => {
            ...
            Trader.decimal('USD_balance', 10, 2).notNullable().default(0.00)
            Trader.decimal('Bitcoin_balance', 10, 2).notNullable().default(0.00)
